...
/*
 * Create n locks on each PE that can be individually locked.
 */
long *hvr_rwlock_create_n(const int n);

/*
 * Acquire the read lock on the specified PE for the RW lock at the specified
 * address.
 */
...
/*
 * Acquire the write lock on the specified PE for the RW lock at the specified
 * address.
 */
